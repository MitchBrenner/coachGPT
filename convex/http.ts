...
http.route({
  ...
  handler: httpAction(async (ctx, request) => {
    ...
    // this means they are a malicious user
    ...
    // then get the event type and if so handle it then save to database
    ...
    console.log("Webhook event processed:", eventType);
...
http.route({
  ...
  handler: httpAction(async (ctx, request) => {
    try {
      ...
      console.log("Workout plan text:", workoutPlanText);
